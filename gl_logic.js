...
//            direction_z = new THREE.Vector3( 0, 0, 1 ).applyQuaternion( cube1.quaternion );
            body1.quaternion.vmult(new CANNON.Vec3( 1, 0, 0 ),direction_x);
            body1.quaternion.vmult(new CANNON.Vec3( 0, 1, 0 ),direction_y);
            body1.quaternion.vmult(new CANNON.Vec3( 0, 0, 1 ),direction_z);
